# 🐝 Topologia Acemar Marques - Laboratório de Redes
...
```bash
git clone https://github.com/acemarM/lab-teste_topologia.git
cd lab-teste_topologia
```
...
### Resultados obtidos nos testes em casa.
- **Teste de Conectivdade (Ping):** Sucesso bidirecional com 0% de perda de pacotes.
- **Desempenho (iperf3):** Alcançou a velocidade média de **19.3 Bbits/sec** com **22.5 GBytes** transferidos.
- **Segurança (hping3):** Ataque SYN Flood executado com sucesso em modo de inundação contínua.
